...
export default function BidderLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: 'Upcoming Auctions', path: '/bidder/upcoming', icon: <><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></> },
    ...
    { name: 'Watchlist', path: '/bidder/watchlist', badge: '5', icon: <><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></> },
    { name: 'Won Auctions', path: '/bidder/won', icon: <><path d="M12 15l-2 5l9-9l-9-9l2 5l-9 9z"/></> },
    { name: 'Messages', path: '/bidder/messages', badge: '2', icon: <><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></> },
    { name: 'Wallet & Escrow', path: '/bidder/wallet', icon: <><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></> },
    { name: 'Saved Searches', path: '/bidder/saved', icon: <><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></> },
    { name: 'Notifications', path: '/bidder/notifications', badge: '3', icon: <><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></> },
    { name: 'Profile Settings', path: '/seller/profile', icon: <><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></> },
    { name: 'Help & Support', path: '/bidder/support', icon: <><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></> }
  ];
            ...
            <div style={{ position: 'relative' }}>
              <div className={s.profileSection} onClick={() => setIsProfileOpen(!isProfileOpen)}>
                <div className={s.profileInfo}>
                  <span className={s.profileName}>{profile.first_name || 'Bidder'} {profile.last_name || ''}</span>
                  <span className={s.profileRole}>Bidder</span>
                </div>
